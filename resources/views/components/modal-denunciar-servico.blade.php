    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content modal-denunciar-usuario">
            ...
            <div class="modal-body">
                <form action="{{ route('denunciar.servico', $servico->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row-denunciar-usuario">
                                <div class="col-denunciar-usuario-esq">
                                    ...
                                    <div class="form-group-denunciar-usuario mb-3">
                                        ...
                                        <input maxlength="30" minlength="10" type="text" name="titulo" class="form-control input-denunciar-usuario">
                                    </div>
                                    <!-- Motivo -->
                                    <div class="form-group-denunciar-usuario mb-3">
                                ...
                                <div class="col-denunciar-usuario-dir">
                                    ...
                                    <div class="form-group-denunciar-usuario mb-3 h-100 d-flex flex-column">
                                        ...
                                        <textarea maxlength="300" minlength="50" name="descricao" id="descricaoDenunciaTeste" class="form-control input-denunciar-usuario flex-grow-1" rows="7" maxlength="500" required placeholder="Descreva o ocorrido com detalhes"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
