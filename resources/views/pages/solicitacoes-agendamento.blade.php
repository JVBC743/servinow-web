                            ...
                            @if($item->id_prestador == auth()->id() && $item->statusAgendamento->status == 'Aguardando confirmação')
                                ...
                                <tr class="text-align-center">
                                    ...
                                    <td class="d-flex justify-content-between">
                                        ...
                                        <div>
                                            <img data-bs-toggle="modal" data-bs-target="#modalSolicitacao{{ $item->id }}"
                                                class="list_icons border border-black rounded"
                                                src="{{ asset('images/verificar.png') }}" alt="">
                                ...
                                <div class="modal fade" id="modalSolicitacao{{ $item->id }}" tabindex="-1"
