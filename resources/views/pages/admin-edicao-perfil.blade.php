                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nome" id="nome" class="form-control"
                                value="{{ old('nome', $usr->nome) }}" maxlength="50" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control"
                                value="{{ old('email', $usr->email) }}" maxlength="80" required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="telefone" id="telefone" class="form-control"
                                value="{{ old('telefone', $usr->telefone) }}" maxlength="15" required>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="descricao" id="descricao" class="form-control" maxlength="300" rows="4"
                                placeholder="Adicione uma breve descrição das suas competências">{{ old('descricao', $usr->descricao) }}</textarea>
                        </div>

                        {{-- Redes sociais --}}
                        <div class="col-md-6 mb-3">
                            <label for="rede_social1" class="form-label">Rede social #1</label>
                            <input type="text" name="rede_social1" id="rede_social1" class="form-control" maxlength="40"
                                value="{{ old('rede_social1', $usr->rede_social1) }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="rede_social2" class="form-label">Rede social #2</label>
                            <input type="text" name="rede_social2" id="rede_social2" class="form-control" maxlength="40"
                                value="{{ old('rede_social2', $usr->rede_social2) }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="rede_social3" class="form-label">Rede social #3</label>
                            <input type="text" name="rede_social3" id="rede_social3" class="form-control" maxlength="40"
                                value="{{ old('rede_social3', $usr->rede_social3) }}">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="rede_social4" class="form-label">Rede social #4</label>
                            <input type="text" name="rede_social4" id="rede_social4" class="form-control" maxlength="40"
                                value="{{ old('rede_social4', $usr->rede_social4) }}">
                        </div>
                        ...
                        <div class="d-flex justify-content-center mt-5 mb-3">
                            <div class="d-flex flex-column align-items-center">
                                @if ($imagem_url)
                                    <img src="{{ $imagem_url }}" alt="Foto do usuário" class="profile_img mb-3"
                                        style="width: 400px">
                                @else
                                    <img src="{{ asset('images/user-icon.png') }}" alt="Usuário sem foto"
                                        class="profile_img mb-3" style="width: 400px">
                                @endif
